...
# form_class = uic.loadUiType('C:\\Pythonsource\\Workspace\\Crawling\\Class\\section6\\ui\\you_viewer_V1.0.ui')[0]
...
class main(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        # QThread 사용 안할 경우
        # QSound.play('C:\\Pythonsource\\Workspace\\Crawling\\Class\\section6\\resource\\intro.wav')
    ...
    def load_url(self):
        ...
        if self.is_play:
            ...
            self.webEngineView.load(QtCore.QUrl('about:blank'))
    ...
    def append_log_msg(self,act):
        ...
        print(app_msg)
        self.plainTextEdit.appendPlainText(app_msg) # insertPlainText : 줄바꿈 없이 실행

        # 활동 로그 저장 (또는 DB 사용)
        with open('C:\\Pythonsource\\Workspace\\Crawling\\Class\\section6\\log\\log.txt','a') as f:
            f.write(app_msg + '\n')
    @pyqtSlot(int)
